...
function applyClaudeDcScoreboardState(scope, scoreboardState = {}) {
  ...
  const prop = {
    awayName: findDeclared('awayName', 'awayNameText'),
    ...
    awayRank: findDeclared('awayRank', 'rankLeftText'),
    awayScore: findDeclared('awayScore', 'scoreLeftText'),
    awayLogo: findDeclared('awayLogo', 'awayLogoUrl'),
    homeName: findDeclared('homeName', 'homeNameText'),
    ...
    homeRank: findDeclared('homeRank', 'rankRightText'),
    homeScore: findDeclared('homeScore', 'scoreRightText'),
