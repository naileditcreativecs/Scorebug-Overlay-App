...
const overlayControl = Object.freeze({
  ...
  saveCustomTeam: (team) => command('save-custom-team', team),
  getTeamCatalog: () => command('get-team-catalog'),
  setThemeSetting: (request) => command('set-theme-setting', request),
  setFavoriteTeam: (request) => command('set-favorite-team', request),
  getTeamPalettes: (request) => command('get-team-palettes', request),
  importTeamPalette: (request) => command('import-team-palette', request),
  deleteTeamPalette: (request) => command('delete-team-palette', request),
  deleteCustomTeam: (request) => command('delete-custom-team', request),
  importCustomTeamLogo: (request) => command('import-custom-team-logo', request),
  clearCustomTeamLogo: (request) => command('clear-custom-team-logo', request),
...
contextBridge.exposeInMainWorld('scoreboard', Object.freeze({
  ...
  setFavoriteTeam: (request) => scoreboardMethod('setFavoriteTeam', request),
  ...
  listDynastySaves: () => scoreboardMethod('listDynastySaves'),
  chooseDynastySave: (savePath) => scoreboardMethod('chooseDynastySave', savePath),
  saveTesterNotes: (notes) => scoreboardMethod('saveTesterNotes', notes),
  exportTestPackage: () => scoreboardMethod('exportTestPackage'),
