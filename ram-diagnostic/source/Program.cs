        ...
        public static int Run(string outputPath)
        {
            try
            {
                ...
                if (!MemoryScanner.LooksLikeDisplayText("T.Dixon 4 Rec, 60 Yds, 1 TD")
                    ...
                    || MemoryScanner.LooksLikeDisplayText("HA&K")
                    || MemoryScanner.LooksLikeDisplayText("o- ;dP")
                    || MemoryScanner.LooksLikeDisplayText("audioCorePostMix")
                    || !MemoryScanner.LooksLikeDisplayText("Hendrickson")
                    || !MemoryScanner.LooksLikeDisplayText("McCall")
                    || !MemoryScanner.LooksLikeDisplayText("RUSH")
